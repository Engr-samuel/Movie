...
<div class="container-fluid mt-5">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#" style="text-decoration: none; color: inherit"><RouterLink to="/">Home</RouterLink></a></li>
  ...
  <div>
    <div class="container-fluid ">
      ...
      <div class="d-flex justify-content-between">
         <h2 class="text-left text-white">{{ genreName }}</h2>
           <nav class="page">
              <ul class="pagination pagination-sm">
                <li class="page-item" :class="{ disabled: currentPage === 1 }">
                  <a class="page-link" href="#" @click.prevent="fetchPreviousPage"><Icon icon="ooui:previous-ltr" color="black" /></a>
                </li>
                ...
                <li class="page-item" :class="{ disabled: currentPage === totalPages }">
                  <a class="page-link" href="#" @click.prevent="fetchNextPage"><Icon icon="ooui:previous-rtl" color="black" /></a>
                </li>
              </ul>
            </nav>
      </div>
