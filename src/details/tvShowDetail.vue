...
export default {
  ...
  methods: {
    ...
    fetchImages() {
      const apiKey = 'e322ec768a4787f47c3a2896362e2b67'
      const id = this.$route.params.id
      const url = `https://api.themoviedb.org/3/tv/${id}/images?api_key=${apiKey}`
  ...
  <main class="d-none -d-md-none d-lg-block">
    ...
    >
      ...
      <div class="container content">
        <div class="row">
          <div class="col-lg-8">
            <h1 class="p-5 pb-2 display-3">{{ movies.name }}</h1>
            <div class="d-flex">
              <button
      ...
      <div class="container my-5">
        <div class="row">
          <div class="col-lg-7">
            <div class="container">
              <div class="top d-flex">
                ...
                >
                  <Icon icon="uil:18-plus" color="green" width="20" />
                </h6>
              </div>
          ...
          <div class="col-lg-5 mt-3">
            ...
            <div class="item mt-4">
              <span class="text-white" style="font-weight: 600">Language: </span>
              <span
                v-for="lang in movies.spoken_languages"
                :key="lang.id"
                class="text-secondary"
